    ...
    <>
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">Revisa y aprueba los documentos de verificación de empresas</p>
        </div>
            ...
            {documents.map((doc) => (
              <Card
                ...
                className={`cursor-pointer transition-all ${
                  selectedDoc?.id === doc.id ? "ring-2 ring-[#1F6357] shadow-lg" : "hover:shadow-md"
                }`}
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800">{getDocumentTypeLabel(doc.document_type)}</h3>
          ...
          {selectedDoc && (
            <Card className="sticky top-8">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold text-gray-800">Revisar Documento</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm text-gray-600 mb-2">Motivo de rechazo (si aplica)</label>
                  <textarea
                ...
                {processing && <div className="text-center text-sm text-gray-500">Procesando...</div>}
              </div>
            </Card>
          )}
        </div>
